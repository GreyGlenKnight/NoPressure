...
public class Room
{
    ...
    public BoardManager.Direction enteringCorridor;    // The direction of the corridor that is entering this room.

    // This is used for the first room.  It does not have a Corridor parameter since there are no corridors yet.
    public void SetupRoom(string roomId, int columns, int rows, IntRange roomWidth, IntRange roomHeight)
    {
        id = roomId;
        ...
        width = roomWidth.RandomInt;
        height = roomHeight.RandomInt;
